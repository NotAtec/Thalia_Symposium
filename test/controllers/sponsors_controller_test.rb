...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference("Sponsor.count") do
      post sponsors_url, params: { sponsor: { body: @sponsor.body, image: @sponsor.image, link: @sponsor.link, slug: @sponsor.slug, title: @sponsor.title } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { body: @sponsor.body, image: @sponsor.image, link: @sponsor.link, slug: @sponsor.slug, title: @sponsor.title } }
