...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference("Lecture.count") do
      post lectures_url, params: { lecture: { abstract: @lecture.abstract, location: @lecture.location, max: @lecture.max, speaker_id: @lecture.speaker_id, title: @lecture.title } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { abstract: @lecture.abstract, location: @lecture.location, max: @lecture.max, speaker_id: @lecture.speaker_id, title: @lecture.title } }
