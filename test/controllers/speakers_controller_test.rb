...
class SpeakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speaker" do
    assert_difference("Speaker.count") do
      post speakers_url, params: { speaker: { body: @speaker.body, image: @speaker.image, name: @speaker.name, slug: @speaker.slug, title: @speaker.title } }
    end
  ...
  test "should update speaker" do
    patch speaker_url(@speaker), params: { speaker: { body: @speaker.body, image: @speaker.image, name: @speaker.name, slug: @speaker.slug, title: @speaker.title } }
