...
class TalksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talk" do
    assert_difference("Talk.count") do
      post talks_url, params: { talk: { body: @talk.body, hall: @talk.hall, slots: @talk.slots, speaker_id: @talk.speaker_id, title: @talk.title } }
    end
  ...
  test "should update talk" do
    patch talk_url(@talk), params: { talk: { body: @talk.body, hall: @talk.hall, slots: @talk.slots, speaker_id: @talk.speaker_id, title: @talk.title } }
